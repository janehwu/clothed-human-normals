...
bool IsInterectingRayTriangle3D(my_float3 ray, my_float3 p0, my_float3 p1, my_float3 p2, my_float3 p3, my_float3 n);
...
my_float3 BicubiInterpolation(my_float3 vertex, float ***tsdf_grid, my_float3 ***grad_grid, my_int3 dim_grid, my_float3 center, float res);
